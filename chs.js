...
var cnRegReplace = new Map([
    ...
    [/^Requires (.+) blue spice galaxies$/, '需要 $1 个 蓝色 香料星系'],
    [/^Requires (.+) pink spice galaxies$/, '需要 $1 个 粉色 香料星系'],
    [/^Requires (.+) red spice galaxies$/, '需要 $1 个 红色 香料星系'],
    [/^Requires (.+) green spice galaxies$/, '需要 $1 个 绿色 香料星系'],
    [/^Requires (.+) yellow spice galaxies$/, '需要 $1 个 黄色 香料星系'],
